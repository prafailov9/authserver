...
COPY /bootstrap/target/*.jar /app/authserver.jar
...
ENTRYPOINT ["sh", "-c", "java $JAVA_OPTS -Djava.security.egd=file:/dev/./urandom -Dspring.config.additional-location=classpath:/application.yml,/app/persistence.yml -jar /app/authserver.jar"]
